...
/*
    Thai CSS Style by Scotty1944
    There's no any Thai font in the game, so I have to inject it manually.
    The font is Noto Sans Thai from Google Fonts.
...
function insertAdditionThaiFont() {
    ...
    style.textContent = `
        ...
        */
        ...
        .tutorial-callout-title, .tutorial-quest-panel-title, .unit-name-font,
        .unit-flag__army-stats, .age-timeline__label, .test-civics-card__title,
        .test-civics-card__icon-bg.test-civics-card__icon-bg--tier-inner,
        .book_narrative__choice-button-text-top, .unit-narrative__title-text,
        .carousel-text, .plot-tooltip__ImprovementName{
            letter-spacing: normal !important;
        }
